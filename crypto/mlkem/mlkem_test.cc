...
//     EXPECT_EQ(0, memcmp(pk_hash, kat.sha3_256_hash_of_public_key.data(),
//     32));

//     uint8_t sk_hash[32];
//     Libcrux_Sha3_256(secretKey, MLKEM768_SECRETKEYBYTES, &sk_hash);
//     EXPECT_EQ(0, memcmp(sk_hash, kat.sha3_256_hash_of_secret_key.data(),
//     32));
...
//     EXPECT_EQ(0, memcmp(ct_hash, kat.sha3_256_hash_of_ciphertext.data(),
//     32)); EXPECT_EQ(0, memcmp(sharedSecret, kat.shared_secret.data(),
...
//     EXPECT_EQ(0,
//               memcmp(sharedSecret, sharedSecret2,
//               MLKEM768_SHAREDSECRETBYTES));
//   }
// }
